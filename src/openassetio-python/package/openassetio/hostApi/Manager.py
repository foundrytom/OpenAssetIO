...
class Manager(_openassetio.hostApi.Manager, Debuggable):
    ...
    def getWithRelationship(
        ...
        entities that have the specified relationship. If there are no
        relations, an empty list will be supplied. The callback will be
        called on the same thread that initiated the call to
        `getWithRelationship`.

        @param errorCallback Callback that will be called for each
        failed relationship query. It will be given the
    ...
    def getWithRelationships(
        ...
        @param successCallback Callback that will be called for each
        successful relationship query. It will be
        given the corresponding index of the relationship in
        `relationshipTraitsDatas` along with a list of entity references
        for entities that have the specified relationship. If there
        are no relations, an empty list will be supplied. The callback
