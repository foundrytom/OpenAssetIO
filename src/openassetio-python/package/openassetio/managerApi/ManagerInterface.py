...
class ManagerInterface(_openassetio.managerApi.ManagerInterface):
    ...
    def getWithRelationship(
        ...
        entities that are related by the input entity by the specified
        relationship. If there are no relations, an empty list should be
        used. The callback must be called on the same thread that
    ...
    def getWithRelationships(
        ...
        entity references for entities that are related by the input
        entity by that relationship. If there are no relations, an empty
        list should be used. The callback must be called on the same
